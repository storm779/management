-- Message Board Data Migration Script
-- Migrating data from vrp_scrollmsg.csv to the message board system
-- CSV Fields: MSGID,MESSAGE,VALIDUPTO,PRIORITY,MSGBY,DTSTAMP,MSG_HEADER,VALIDFROM,ENABLED,MESSAGE_HINDI,MSG_HEADER_HINDI

-- First, let's check if the table exists and clear any existing data (optional)
-- DELETE FROM vrp_scrollmsg WHERE ID > 0;

-- Insert migration data from CSV
...
INSERT INTO vrp_scrollmsg (
    ...
    '2016-12-15',  -- MODIFIED_DATE
    '2016-12-15 00:33:09',  -- DTSTAMP: 33:09.0 (assuming time format)
    '',            -- MESSAGE_HINDI: empty
    '',            -- MSG_HEADER_HINDI: empty
    1,             -- DISPLAY_ORDER: 1 (first record)
